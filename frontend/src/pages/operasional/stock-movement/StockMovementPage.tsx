...
const StockMovementPage = () => {
  ...
  const isSalesDiv = profile?.role === "SALES_DIV";
  ...
  return (
    <DashboardLayout>
      <h1 className="text-3xl font-bold mb-6 text-neon-cyan">
        {isSalesDiv ? "Warehouse Inventory" : "Stock Movement Management"}
      </h1>

      {isSalesDiv ? (
        /* SALES_DIV: read-only inventory view only */
              ...
              <Table className="text-gray-300">
                <TableHeader className="glassmorphism border-b border-gray-700">
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="text-neon-cyan">Warehouse Inventories</TableHead>
                    <TableHead className="text-neon-cyan">Total Stock</TableHead>
        ...
        /* SUPER_ADMIN / OPERASIONAL_DIV: full two-panel layout */
