...
BEGIN
  ...
  IF NEW.status = 'CLOSED' AND OLD.status IS DISTINCT FROM 'CLOSED' THEN
    ...
    LOOP
      ...
      VALUES (po_item.product_id, v_target_warehouse_category::public.warehouse_category_enum, po_item.qty_received, po_item.user_id)
      ...
      INSERT INTO public.stock_ledger (
        ...
        po_item.user_id,
        po_item.product_id,
        'PO_RECEIPT'::public.stock_event_type, -- Ensure event_type is also cast
        po_item.qty_received,
        v_target_warehouse_category::public.warehouse_category_enum, -- Explicitly cast here
