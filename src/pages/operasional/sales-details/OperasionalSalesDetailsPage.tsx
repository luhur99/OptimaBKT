...
const OperasionalSalesDetailsPage: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-3xl font-bold mb-6 text-neon-cyan">Operasional Sales Details</h1>
      <p className="text-gray-300">This page will display detailed sales information.</p>
    </DashboardLayout>
  );
};

export default OperasionalSalesDetailsPage;