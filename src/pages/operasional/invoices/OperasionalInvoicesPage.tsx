...
const OperasionalInvoicesPage: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-3xl font-bold mb-6 text-neon-cyan">Operasional Invoices</h1>
      <p className="text-gray-300">This page will display a list of all invoices managed by operasional.</p>
      {/* You can start adding your table and other components here */}
    </DashboardLayout>
  );
};

export default OperasionalInvoicesPage;