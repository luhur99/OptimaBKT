...
const WarehouseProductsPage: React.FC = () => {
  ...
  const allowedRoles = ["SUPER_ADMIN", "WAREHOUSE_STAFF", "PURCHASING_STAFF"];
  ...
  return (
    <DashboardLayout>
      <h1 className="text-3xl font-bold mb-6 text-neon-cyan">Warehouse Products</h1>
      <p className="text-gray-300">This page will display and manage all products in the warehouse.</p>
    </DashboardLayout>
  );
};
