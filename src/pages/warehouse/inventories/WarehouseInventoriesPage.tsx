...
const WarehouseInventoriesPage: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-3xl font-bold mb-6 text-neon-cyan">Warehouse Inventories</h1>
      <p className="text-gray-300">This page will display all warehouse inventories.</p>
    </DashboardLayout>
  );
};
