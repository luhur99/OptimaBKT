...
const PurchasingPurchaseRequestsPage: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-3xl font-bold mb-6 text-neon-cyan">Purchasing Purchase Requests</h1>
      <p className="text-gray-300">This page will manage all purchase requests.</p>
    </DashboardLayout>
  );
};

export default PurchasingPurchaseRequestsPage;