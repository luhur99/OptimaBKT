...
interface PurchaseRequestTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
  onRowClick: (pr: TData) => void;
}

export function PurchaseRequestTable<TData, TValue>({
  columns,
  data,
  onRowClick,
}: PurchaseRequestTableProps<TData, TValue>) {
