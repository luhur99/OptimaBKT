...
interface DeliveryOrderTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
  onRowClick?: (po: TData) => void; // Optional row click handler
}

export function DeliveryOrderTable<TData, TValue>({
  columns,
  data,
  onRowClick,
}: DeliveryOrderTableProps<TData, TValue>) {
