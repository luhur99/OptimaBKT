  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/" element={<PrivateRoute allowedRoles={["SUPER_ADMIN", "OPERASIONAL_DIV", "TECHNICIAN", "SALES_DIV", "WAREHOUSE_STAFF", "PURCHASING_STAFF", "ACCOUNTING"]}><IndexPage /></PrivateRoute>} />
        <Route path="/dashboard" element={<PrivateRoute allowedRoles={["SUPER_ADMIN", "OPERASIONAL_DIV", "TECHNICIAN", "SALES_DIV", "WAREHOUSE_STAFF", "PURCHASING_STAFF", "ACCOUNTING"]}><DashboardPage /></PrivateRoute>} />
